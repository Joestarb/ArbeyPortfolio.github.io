...
function AboutMe() {
  ...
  return (
    ...
    <h1 className=" text-white text-center font-semibold headerText text-2xl">About Me</h1>
      <div className="grid grid-cols-2 place-content-center headerText aboutMebg mx-12 rounded-lg">
  
        <div>
          <h1 className=" text-white  font-semibold p-7 text-justify text-sm">
      ...
      <h1 className=" text-white text-center font-semibold  text-2xl mt-12">Skills</h1>
      <div className="flex flex-wrap justify-around gap-6 anime-icon ">
